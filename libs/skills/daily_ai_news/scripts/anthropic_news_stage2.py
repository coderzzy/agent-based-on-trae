#!/usr/bin/env python3
"""
Anthropic News - Stage 2
从详情页 HTML 提取文章内容

Usage:
    python anthropic_news_stage2.py --stage1 ./output/stage1/news.json --articles-dir ./output/html/articles --output ./output/stage2/news.json
"""
...
def main():
    parser = argparse.ArgumentParser(description='Anthropic News Stage 2: 从详情页提取内容')
    ...
    print(f"[News Stage 2] 处理 {args.stage1}")
