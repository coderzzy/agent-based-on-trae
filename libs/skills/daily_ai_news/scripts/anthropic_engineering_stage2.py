#!/usr/bin/env python3
"""
Anthropic Engineering - Stage 2
从详情页 HTML 提取文章内容

Usage:
    python anthropic_engineering_stage2.py --stage1 ./output/stage1/engineering.json --articles-dir ./output/html/articles --output ./output/stage2/engineering.json
"""
...
def main():
    parser = argparse.ArgumentParser(description='Anthropic Engineering Stage 2: 从详情页提取内容')
    ...
    print(f"[Engineering Stage 2] 处理 {args.stage1}")
